...
> - Antes de ejecutar el proyecto, debes crear una base de datos en PostgreSQL (por ejemplo, `dbproject`) y ejecutar el script SQL incluido más abajo, Aqui el script para crear la base de datos.
```sql
